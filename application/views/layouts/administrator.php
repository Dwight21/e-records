...
<div class="wrapper ">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="/e-records/admin/" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><img src="<?php echo base_url('resources/img/logo.png'); ?>" class="user-image" id="logo-header" alt="User Image" > </span>
      <!-- logo for regular state and mobile devices -->
      <div class="logo-display"> 
        <img src="<?php echo base_url('resources/img/logo.png'); ?>" class="user-image" id="logo-header" alt="User Image" > 
        <span>E-Records</span>
      </div>
