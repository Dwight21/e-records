...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2017 at 05:43 AM
...
CREATE TABLE `exam_criteria` (
  ...
  `exam_yearLevel` varchar(255) NOT NULL,
  `start` time NOT NULL,
  `end` time NOT NULL,
...
CREATE TABLE `quiz_criteria` (
  ...
  `q_section` varchar(255) NOT NULL,
  `q_yearLevel` varchar(255) NOT NULL,
...
--
ALTER TABLE `tblparent`
  ADD CONSTRAINT `parentCodeFK` FOREIGN KEY (`parentCode`) REFERENCES `tblstudent` (`parentCode`) ON UPDATE CASCADE,
